...
import { SettingOutlined, BulbOutlined, TableOutlined, ControlOutlined,GoldOutlined, CodeOutlined,ColumnHeightOutlined,DownloadOutlined } from '@ant-design/icons-vue';
...
const functionList = computed(() => [
    ...
    { icon: ColumnHeightOutlined, title: "触发键设置", key: 'trigger' },
    { icon: GoldOutlined, title: "高级键设置", key: 'advanced' },
    { icon: CodeOutlined, title: "宏设置", key: 'macro' },
    { icon: DownloadOutlined, title: "磁轴校准", key: 'magneticAxisCalibration' },
